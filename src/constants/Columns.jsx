...
export const categoryColumns = ( navigate) => [
  {
    key: "id",
    title: "id",
    width: "100px",
...
export const subcategoryColumns = () => [
  ...
  },
  {
    ...
    width: "300px",
    render: (item) => (
      <span className="font-semibold text-center ms-20 ">{item?.products || 0}</span>
    ),
  },
  // {
  //   key: "image",
...
export const userColumns = (navigate, t) => [
...

  {
    ...
    title: t("status"),
    width: "175px",
    render: (item) => <span className="font-semibold">{item?.is_active == 1 ? "Active" : "Inactive"}</span>,
  },
  {
    key: "actions",
    title: t("actions"),
...
export const currencyColumns = () => [
  ...
  //       {(item.rate * item.cost).toFixed(2)} {item.to_currency}
  //     </span>
  //   ),
  // },
];
