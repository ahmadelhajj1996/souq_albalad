...
export const sellerInitialValues = (mode, selectedItem) => {
...
export const sellerSubmit = (mode, selectedItem, values, closeModal) => {
  if (mode === "add") {
    console.log("Adding new seller", values);
  } else if (mode === "edit") {
...
export const sellerDelete = (seller, t) => {
...
export const sellerFreeze = (seller, t) => {
