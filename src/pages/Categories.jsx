...
function Categories() {
  ...
  const columns = useMemo(
    () => categoryColumns(openEditModal, openDeleteModal, navigate),
    [openEditModal, openDeleteModal, navigate]
  );
  ...
  const handleSubmit = useCallback(
    (values) => {
      ...
      if (modalState.mode === "add") {
        createCategory({ url: "categories", data: payload });
      } else if (modalState.mode === "edit") {
        updateCategory({
          url: `categories/${modalState.selectedItem.id}`,
          data: payload,
        });
      }
    },
  ...
  const handleDelete = useCallback(() => {
    ...
    deleteCategory({ url: `categories/${modalState.selectedItem.id}` });
